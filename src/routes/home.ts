...
${head('Home', 'AREN ATHLETIC — Apparel built for training and everything after. Minimal. Durable. Elevated. Designed for the gym, the street, and the pace of New York.')}
    ...
    <div class="philosophy-inner">
      ...
      <div class="philosophy-left">
        ...
        <h2 class="philosophy-headline">
          The standard<br>is the standard.
        </h2>
        <p class="philosophy-copy">
          AREN is built on discipline, presence, and consistency — apparel designed to perform in training and carry the standard everywhere else in life.
        </p>
      ...
      <div class="street-miles-content">
        ...
        <div class="street-miles-stats">
          <div>
            ...
            <div class="sm-stat-label">Boroughs</div>
          </div>
          <div>
