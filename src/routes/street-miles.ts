...
${head('Street Miles NYC', 'Street Miles NYC — A weekly run club built on exploration, effort, and community. Every Sunday at 09:00 across the five boroughs.')}
...
<section class="sm-hero">
  <div class="container">
    ...
    <p style="font-size:1.0625rem;line-height:1.7;color:rgba(255,255,255,0.5);max-width:46ch;margin-bottom:3rem;">
  ...
  <div class="container">
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:var(--space-xl);align-items:start;">
      <div>
        ...
        <h2 class="text-h2" style="max-width:18ch;margin-bottom:2rem;">A disciplined run culture built on shared accountability.</h2>
      </div>
      <div>
    ...
    <div class="protocol-items">
      ...
      <div class="protocol-item">
        ...
        <p class="protocol-desc">
          Every Sunday at 09:00 sharp. We execute rotating sessions across the five boroughs—focused on bridges, blocks, and industrial sectors. No exceptions.
        </p>
      </div>
      ...
      <div class="protocol-item">
        ...
        <p class="protocol-desc">
          From aerobic capacity builds to high-intensity urban splits. Each run is a specific tactical unit within the AREN training protocol. Run types vary weekly.
        </p>
      </div>
      ...
      <div class="protocol-item">
        ...
        <p class="protocol-desc">
          Presence is the benchmark. Sync via the chapter channel for RSVP and live tracking. Missing sessions is a breach of the standard. Vigilance is mandatory.
        </p>
      </div>
...
<section class="section" style="background:var(--color-black);color:var(--color-white);">
  <div class="container">
    <div class="text-eyebrow" style="color:rgba(255,255,255,0.3);margin-bottom:3rem;">Chapters</div>
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:var(--space-xl);align-items:center;">
      <div>
        <h2 style="font-family:var(--font-serif);font-size:clamp(1.8rem,3.5vw,3rem);font-weight:400;line-height:1.1;color:#fff;letter-spacing:-0.015em;margin-bottom:1.75rem;">
          Street Miles NYC — The Five Borough Chapter
        </h2>
        <p style="font-size:0.9375rem;line-height:1.75;color:rgba(255,255,255,0.5);margin-bottom:1.75rem;max-width:44ch;">
        ...
        <p style="font-size:0.9375rem;line-height:1.75;color:rgba(255,255,255,0.5);max-width:44ch;">
  ...
  <div class="container">
    ...
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:0;border:1px solid rgba(255,255,255,0.08);">
      ...
      <div style="padding:3.5rem 3rem;border-right:1px solid rgba(255,255,255,0.08);">
        ...
        <p style="font-size:0.9rem;line-height:1.65;color:rgba(255,255,255,0.45);">Join the digital hub for real-time coordinates, session details, and chapter communication.</p>
      </div>
      ...
      <div style="padding:3.5rem 3rem;border-right:1px solid rgba(255,255,255,0.08);">
        ...
        <p style="font-size:0.9rem;line-height:1.65;color:rgba(255,255,255,0.45);">Arrival is mandatory. We run in all conditions. There is no acceptable reason to miss without prior coordination.</p>
      </div>
      ...
      <div style="padding:3.5rem 3rem;">
        ...
        <p style="font-size:0.9rem;line-height:1.65;color:rgba(255,255,255,0.45);">Carry the weight and complete the miles. Every session is a unit in a larger protocol. The work compounds.</p>
      </div>
