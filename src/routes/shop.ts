...
${head('Shop', 'AREN ATHLETIC Shop — Core Tee, Heavyweight Hoodie, Performance Layer, Essential Cap. Minimal. Durable. Elevated.')}
  ...
  <div class="container">
    <div style="display:flex;align-items:flex-end;justify-content:space-between;gap:2rem;flex-wrap:wrap;">
      ...
      <p class="text-body" style="max-width:44ch;">
        Performance-informed apparel built for daily standards, not trends. Function. Restraint. Durability.
      </p>
    </div>
  </div>
</section>
...
<!-- APPAREL PHILOSOPHY BANNER -->
<section style="padding:3rem 0;background:var(--color-off-white);border-bottom:1px solid var(--color-warm-gray);">
  <div class="container">
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:0;text-align:center;">
      <div style="padding:2rem;border-right:1px solid var(--color-warm-gray);">
        <div class="text-eyebrow" style="margin-bottom:0.75rem;">Training</div>
        <p class="text-body-sm">Engineered for high-output environments.</p>
      </div>
      <div style="padding:2rem;border-right:1px solid var(--color-warm-gray);">
        <div class="text-eyebrow" style="margin-bottom:0.75rem;">Daily Wear</div>
        <p class="text-body-sm">Structured comfort for every transition.</p>
      </div>
      <div style="padding:2rem;">
        <div class="text-eyebrow" style="margin-bottom:0.75rem;">Outer Layers</div>
        <p class="text-body-sm">Technical protection for urban defense.</p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="shop-product-grid">
      ...
      <div class="product-card">
        ...
        <div class="product-name">Core Tee — White/Tonal</div>
      ...
      <div class="product-card">
        ...
        <div class="product-name">Core Tee — Black</div>
      ...
      <div class="product-card">
        ...
        <div class="product-name">Boxy Tee — Sand</div>
...
<section style="background:var(--color-black);padding:var(--space-xl) 0;margin-top:var(--space-lg);">
  <div class="container">
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:var(--space-xl);align-items:center;">
      <div>
        <div class="text-eyebrow" style="color:rgba(255,255,255,0.3);margin-bottom:2rem;">Not Streetwear. A System.</div>
        <h2 style="font-family:var(--font-serif);font-size:clamp(1.8rem,3.5vw,3rem);font-weight:400;color:#fff;line-height:1.1;letter-spacing:-0.015em;margin-bottom:1.75rem;max-width:20ch;">
          Equipment for people who operate.
        </h2>
        <p style="font-size:0.9375rem;line-height:1.75;color:rgba(255,255,255,0.5);max-width:44ch;">
          AREN apparel is not clothing for spectators. Every piece is designed to hold up under training and carry that same standard into the rest of life.
        </p>
      </div>
