...
<section class="shop-grid">
  <div class="container">
    ...
    <div class="shop-product-grid">
      ...
      <div class="product-card">
        <div class="product-image" style="background:#232321;"><div class="product-image-placeholder" style="opacity:0.5;">${iconTee()}</div></div>
      ...
      <div class="product-card">
        <div class="product-image" style="background:#e0d2b2;"><div class="product-image-placeholder">${iconTee()}</div><div class="product-tag">New</div></div>
      ...
      <div class="product-card">
        <div class="product-image" style="background:#2e2e2b;"><div class="product-image-placeholder" style="opacity:0.4;">${iconHoodie()}</div><div class="product-tag">New</div></div>
      ...
      <div class="product-card">
        <div class="product-image" style="background:#d6d0c4;"><div class="product-image-placeholder">${iconLayer()}</div></div>
      ...
      <div class="product-card">
        <div class="product-image" style="background:#ece3cf;"><div class="product-image-placeholder">${iconTee()}</div></div>
      ...
      <div class="product-card">
        <div class="product-image" style="background:#d6d0c4;"><div class="product-image-placeholder">${iconCap()}</div></div>
      ...
      <div class="product-card">
        <div class="product-image" style="background:#2e2e2b;"><div class="product-image-placeholder" style="opacity:0.4;">${iconCap()}</div></div>
